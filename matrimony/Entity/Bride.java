...
public class Bride {
	...
	public String toString() {
		return "Bride [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", password=" + password
				...
				+ country + ", plans=" + plans + ", maritalStatus=" + maritalStatus + "]";
	}
	public Bride(long id, String firstName, String lastName, String password, String emailId, long phoneNo,
